 ...
 */
export function generateMarkdownReport(report, issuesOnly = false) {
    ...
    for (const section of sections) {
        const sectionResults = issuesOnly
            ...
            : section.results;
        if (issuesOnly && sectionResults.length === 0)
            continue;
 ...
 */
export function generateAiContextReport(report, condensedGuide, issuesOnly = false) {
 ...
 */
export function generateBatchReport(reports) {
    const lines = [

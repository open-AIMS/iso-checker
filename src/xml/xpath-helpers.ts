 ...
 */
export function buildNamespaceResolver(root: Element): XPathNSResolver {
 ...
 * Rules-design.md §2.
 */
export function detectSchema(doc: Document): SchemaType {
...
export function xpathText(
  ...
  if (el.getAttribute('gco:nilReason') === 'missing') return null;
 ...
 * Rules-design.md §4.
 */
export function extractCodeValue(codeParent: Element, resolver: XPathNSResolver): {
  text: string | null;
  isAnchor: boolean;
